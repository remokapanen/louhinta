...
Jos sinulla ei ole Ankia jo valmiiksi tai et osaa käyttää sitä, kts. [toinen oppaani](https://ankin-perusteet.netlify.app/)

## Ankiconnect 

Lataa Ankiconnect add-on. 

- Ankissa Tools -> Add-ons -> Get add-ons -> liitä kenttään tämä koodi: 2055492159 
...
- Import file -> valitse ladattu tiedosto

## Pakka 

Tee pakka, johon haluat louhittujen korttien menevän.

- Ankissa Create Deck -> anna pakalle sopiva nimi (esim. Mining)

## Millaisia kortit ovat? 
...
![Click card -esimerkki](_main_files/Click_card.gif)