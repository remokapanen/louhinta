...
Nyt setup alkaa olla valmista. Seuraavaksi käydään läpi, miten louhinta toimii oikeasti, eli käydään läpi workflow siinä yhteydessä, kun tapaat uuden sanan immersiossasi. 
...
3. Paina Ctrl+Shift+U (tai asettamasi shortcut), jolla klippaat kyseisen kohdan audion sekä otat pienen screenshotin videosta juuri aikaisemmin tekemääsi korttiin. 

4. Jos tuntuu siltä, että asbplayer klippaa audion liian aikaisin/liian myöhään, niin "audio paddingia" voi säädellä asetuksista Kohdasta Mining -> Audio padding start / Audio padding end 

## Louhinta Youtubesta 

Youtube-videoista louhiminen onnistuu käytännössä aina, sillä suurimmalle osalle videoista on mahdollista laittaa päälle vähintään autogeneroidut tekstit. Näiden laatu kuitenkin riippuu todella paljon videon puheen selvyydestä.
...
- Valitse Subtitle track 1 -> Valitse haluamasi tekstitykset (aina ei ole tarjolla mitään); huom. hiirellä klikkailu ei aina toimi, nuolinäppäimiä joutuu ehkä käyttämään tässä valinnassa (videolla toimii hiirellä)
- Paina enter 

Nyt sinulla pyörii louhittavissa olevat tekstit Youtube-videossa. 

![](_main_files/youtubelouhinta.gif)
...
Jos haluat japaninkieliset tekstit jaksoihin, niin hae katsomasi sarjasi nimi Jimaku -sivustolta: https://jimaku.cc/

- Lataa katsomasi jakson tekstitystiedosto; filetyypillä ei niin paljoa väliä (ihs onko .srt vai .ass; itse olen ass-miehiä)
- Vedä tiedosto videon päälle -> nyt sinulla on japaninkieliset tekstit jaksollesi 

Tämä metodi tietysti toimii myös mille tahalle muullekin kielelle, jos satut löytämään sivuston, jossa tavoitekielesi sarjojen tekstejä on tarjolla ladattaviksi. 

![](_main_files/aniwatchlouhinta.gif)
